...
void Sphere::printSummary(int precision) const {
	...
	// Radius
	cout << setw(COLUMN_WIDTH) << "Radius:" << setw(COLUMN_WIDTH) << radius
		 << endl;

	// Color
	cout << setw(COLUMN_WIDTH) << "Color:" << setw(COLUMN_WIDTH);
	switch (color) {
		case 'B':
			cout << "Blue";
			break;
	...
	// Diameter
	cout << setw(COLUMN_WIDTH) << "Diameter:" << setw(COLUMN_WIDTH)
		 << getDiameter() << endl;

	// Volume
	cout << setw(COLUMN_WIDTH) << "Volume:" << setw(COLUMN_WIDTH) << getVolume()
		 << endl;

	// Surface Area
	cout << setw(COLUMN_WIDTH) << "Surface Area:" << setw(COLUMN_WIDTH)
		 << getSurfaceArea() << endl;
}
