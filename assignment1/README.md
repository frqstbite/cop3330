...
```cpp
MIN_GPA = 0.0, MAX_GPA = 4.0
MIN_CREDITS = 0, MAX_CREDITS = 180
```
...
### 2.2 Implement Required Functions
...
#### 2.2.1 `Student makeStudent(int id, double gpa, int credits)`
...
#### 2.2.2 `bool isValidStudent(Student& s)`
...
#### 2.2.3 `bool updateGPA(Student& s, double newGPA)`
...
#### 2.2.4 `bool addCredits(Student& s, int creditsToAdd)`
...
#### 2.2.5 `bool addCredits(Student& s)`
